...
build:
	...
	docker build -t $(dockerhub_user)/hadoop-docker-spark:$(current_branch) ./spark
...
tag-latest:
	...
	docker tag $(dockerhub_user)/hadoop-docker-spark:$(current_branch) $(dockerhub_user)/hadoop-docker-spark:latest
...
push:
	...
	docker push $(dockerhub_user)/hadoop-docker-spark:$(current_branch)
...
push-latest:
	...
	docker push $(dockerhub_user)/hadoop-docker-spark:latest
